...
description: First-time setup flow for cover-image-prompts preferences
---
...
```yaml
header: "Watermark"
question: "Watermark text for generated cover prompts?"
options:
  - label: "No watermark (Recommended)"
    description: "Clean covers, can enable later in EXTEND.md"
```

### Question 2: Title Language

```yaml
header: "Language"
question: "Default title language for cover prompts?"
options:
  - label: "Auto-detect (Recommended)"
    description: "Detect from content or user input"
  - label: "English"
    description: "Use English for all titles"
  - label: "Chinese"
    description: "Use Chinese for all titles"
```

### Question 3: Preferred Type
...
```yaml
header: "Aspect"
question: "Default aspect ratio for cover prompts?"
options:
...
```yaml
header: "Output"
question: "Default output directory for cover prompts?"
options:
  - label: "Independent (Recommended)"
    description: "cover-image-prompts/{topic-slug}/ - separate from article"
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.baoyu-skills/cover-image-prompts/EXTEND.md` | Current project |
| User | `~/.baoyu-skills/cover-image-prompts/EXTEND.md` | All projects |
