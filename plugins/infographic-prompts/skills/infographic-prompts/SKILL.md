...
```bash
/infographic-prompts path/to/content.md
/infographic-prompts path/to/content.md --layout hierarchical-layers --style technical-schematic
/infographic-prompts path/to/content.md --aspect portrait --lang zh
/infographic-prompts  # then paste content
```
...
```
infographic-prompts/{topic-slug}/
├── source-{slug}.{ext}
├── analysis.md
...
### Step 6: Output Prompt

**6.1 Save Prompt to File**

Save the assembled prompt to `prompts/infographic.md`.

The prompt file contains:
- Full layout guidelines
- Complete style specifications
- Content-specific visual instructions
- All text labels in the target language

**6.2 Display Summary to User**

Output:
- File path to the saved prompt
- Preview of prompt sections
- Usage instructions
...
Output Files:
- prompts/infographic.md (ready-to-use prompt)

Source & Analysis:
- source-{slug}.md (original content)
- analysis.md (content analysis)
- structured-content.md (structured breakdown)

How to use this prompt:
1. Copy the content from prompts/infographic.md
2. Paste into your preferred image generation tool
3. Or use with an image generation skill:
   /baoyu-danger-gemini-web --promptfile infographic-prompts/[slug]/prompts/infographic.md
```
