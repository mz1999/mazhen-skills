...
description: First-time setup flow for article-illustrator-prompts preferences
---
...
```
header: "Watermark"
question: "Watermark text for generated illustration prompts? Type your watermark content (e.g., name, @handle)"
options:
...
```
header: "Language"
question: "Preferred language for illustration prompts?"
options:
  - label: "Auto-detect (Recommended)"
    description: "Detect from article content"
  - label: "English"
    description: "Generate prompts in English"
  - label: "Chinese"
    description: "Generate prompts in Chinese"
```
...
| Choice | Path | Scope |
|--------|------|-------|
| Project | `.baoyu-skills/article-illustrator-prompts/EXTEND.md` | Current project |
| User | `~/.baoyu-skills/article-illustrator-prompts/EXTEND.md` | All projects |
