...
description: EXTEND.md YAML schema for article-illustrator-prompts user preferences
---
...
default_output_dir: null  # same-dir|prompts-subdir|independent
...
| `prompts-subdir` | `{article-dir}/prompts/` subdirectory |
| `independent` | `article-illustrator-prompts/{topic-slug}/` in working directory |
