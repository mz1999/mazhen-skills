---
name: twitter-cli
description: CLI for Twitter/X operations — reading, posting, replying, quoting, liking, retweeting, following, searching, and user lookups.
author: jackwener
version: "0.8.0"
tags:
  - twitter
...
执行下面的任何命令前，必须使用下面的环境变量：

```bash
TWITTER_BROWSER=chrome
TWITTER_PROXY=socks5://127.0.0.1:7897
```
